                ...
                <div className='flex flex-col md:flex-row gap-10'>
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='container flex flex-col justify-center items-center'>
                            <Image src="/Images/JaronPicture.png" alt="Jaron Anderson" width={400} height={400} className='mb-8 w-[300px] md:w-[400px]' />
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='container pl-0 sm:pl-6 flex flex-col justify-center items-center'>
                            <Image src="/Images/HunterPicture.png" alt="Hunter Knott" width={300} height={300} className='mb-8 w-[200px] sm:w-[300px]' />
