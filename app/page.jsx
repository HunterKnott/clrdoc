  ...
  useEffect(() => {
    ...
    const fetchTenants = async () => {
      ...
      if (error) {
        ...
        setTenants(data);
        if (data.length > 0) {
          setSelectedTenant({ id: data[0].id, name: data[0].name, styles: data[0].styles });
        }
        ...
        isValidSubdomain ? (
          <main id="subdomain-page">
            <NavBar
              ...
              logoText=""
              logoImage={`${selectedTenant.styles ? selectedTenant.styles.header_logo : ''}`}
              hoverColor={`${selectedTenant.styles ? selectedTenant.styles.accent_color : ''}`}
            />
            ...
            <Footer background="#691b33" logoText="" logoImage={`${selectedTenant.styles ? selectedTenant.styles.footer_logo : ''}`} />
          </main>
        ) : (
          <main id="error-page">
