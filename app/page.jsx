...
export default function Home() {
  ...
  //   if (!isValidSubdomain) {
  //     return (
  //       <main className="bg-gray-100 flex min-h-screen flex-col items-center justify-center">
  //         <h1 className="text-4xl font-bold text-center text-black">Error: Invalid subdomain</h1>
  //       </main>
  //     );
  //   }
  //   return (
