...
export default function KeenEyeFamilyVision() {
    return <h1>Keen Eye Family Vision</h1>
...
//   useEffect(() => {
//     // Fetch subdomain from URL params
...
//         setTenants(data);
//         if (data.length > 0) {
//           // If subdomain exists, find matching tenant, otherwise use first tenant
//           const matchingTenant = subdomainParam
//             ? data.find(tenant => tenant.subdomain === subdomainParam)
//             : data[0];
//           setSelectedTenant(matchingTenant?.id || data[0].id);
//         }
//       }
//     };
...
//             <h1 className="font-bold text-3xl mb-4 sm:mb-0">
//               {subdomain === 'keeneyefamilyvision'
//                 ? 'Keene Eye Family Vision: Find your Perfect Eyewear'
//                 : 'Patient Portal'}
//             </h1>
...
//             {subdomain === 'keeneyefamilyvision'
//               ? 'Keen Eye Family Vision Featured Products'
//               : 'Featured Products'}
//           </h2>
